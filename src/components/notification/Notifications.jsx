            ...
            {notifications && notifications.length > 0 ? (
              notifications.map((notification) => (
                ...
                <div style={{display:"flex",flexDirection:"column",alignItems:"center",paddingTop:"50px"}}>
                    <img src="/src/assets/notification.png" height={150} width={150}/>
                    <Typography variant="body1" color="textSecondary" alignText="center">No notifications to show</Typography>
                </div>
            )}
          </TabPanel>
